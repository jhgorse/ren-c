...
Revolt rethinks this idea to have one executable ACTION! type, which gets its
...
Of particular interest to Revolt is creating actions that are slight variants

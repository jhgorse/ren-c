...
//=////////////////////////////////////////////////////////////////////////=//
//
// Copyright 2019-2020 Revolt Open Source Contributors
//
...
//     x is 10
//
// AUGMENT leverages Revolt's concept of "refinements are their own arguments"
...
static REB_R Augmenter_Dispatcher(REBFRM *f)
{
    ...
    f_binding = VAL_BINDING(augmentee);
